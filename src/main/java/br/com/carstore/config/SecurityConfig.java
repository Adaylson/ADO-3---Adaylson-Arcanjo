...
public class SecurityConfig {
    ...
    // --- CONFIGURAÇÃO DA API (PRIORIDADE 1) ---
    @Bean
    ...
    public SecurityFilterChain apiFilterChain(HttpSecurity http, JwtRequestFilter jwtRequestFilter) throws Exception {
        http
                .securityMatcher("/api/**") // Aplica apenas para URLs que começam com /api/
                .csrf(csrf -> csrf.disable()) // API não precisa de CSRF
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .anyRequest().authenticated() // Bloqueia o resto da API
                )
    ...
    // --- CONFIGURAÇÃO WEB/PÁGINAS (PRIORIDADE 2) ---
    @Bean
    @Order(2)
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // LIBERA A API DE AUTENTICAÇÃO (Se for REST)
